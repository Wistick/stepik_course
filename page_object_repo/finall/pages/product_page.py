...
class ProductPage(BasePage):
    ...
    def should_be_correct_message_alert(self):
        ...
        assert self.is_element_present(*ProductPageLocators.BASKET_PRICE), 'Basket item name is not presented'
        assert self.is_element_present(*ProductPageLocators.BASKET_NAME), 'Basket item price is not presented'
        ...
        assert product_name in basket_name, 'Item name does not match!'
        assert product_price in basket_price, 'Item price does not match'
